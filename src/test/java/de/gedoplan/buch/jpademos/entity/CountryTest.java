...
public class CountryTest extends TestBase
{
  ...
  public void testSelectContinentDescriptionAsValueObject()
  {
    ...
    TypedQuery<ContinentDescription> query = this.entityManager.createQuery(
        "select new de.gedoplan.buch.jpademos.helper.ContinentDescription(c.continent, avg(c.population)) from Country c group by c.continent", ContinentDescription.class);
   ...
   * 
   * @author Dirk Weil, Michael Sch�fer 
   * 
   */
  @Test
  // @Ignore
  public void testDynamicNamedQuery()
  {
	...
	try {
		...
		Assert.fail("Queries k�nnen nicht gelesen werden");
	}
